...
<head>
    ...
    <title>Blog Grids | {{ tenant('id') }}</title>
    <link rel="shortcut icon" href="{{ tenant_asset('images/favicon.png') }}" type="image/x-icon" />
    <link rel="stylesheet" href="{{ tenant_asset('css/animate.css') }}" />
    <link rel="stylesheet" href="{{ tenant_asset('css/tailwind.css') }}" />

    <!-- ==== WOW JS ==== -->
    <script src="{{ tenant_asset('js/wow.min.js') }}"></script>
    <script>
        new WOW().init();
    </script>
</head>
...
<body>
    ...
    <!-- ====== All Scripts -->
    <script src="{{ tenant_asset('js/main.js') }}"></script>
</body>
